...
[Release Downloads](https://github.com/aibotsoft/migrate/releases)

```bash
$ curl -L https://github.com/aibotsoft/migrate/releases/download/$version/migrate.$platform-amd64.tar.gz | tar xvz
```
...
```bash
$ go get -u -d github.com/aibotsoft/migrate/cmd/migrate
$ cd $GOPATH/src/github.com/aibotsoft/migrate/cmd/migrate
$ git checkout $TAG  # e.g. v4.1.0
$ go build -tags 'postgres' -ldflags="-X main.Version=$(git describe --tags)" -o $GOPATH/bin/migrate $GOPATH/src/github.com/aibotsoft/migrate/cmd/migrate
```

#### Unversioned

```bash
$ go get -tags 'postgres' -u github.com/aibotsoft/migrate/cmd/migrate
```
...
1. Support for build constraints will be removed in the future: https://github.com/aibotsoft/migrate/issues/60
